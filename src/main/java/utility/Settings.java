...
public class Settings {
	...
	private String[][] defaultGuitarTuning = { { "E", "4" }, { "B", "3" }, { "G", "3" }, { "D", "3" }, { "A", "2" },
			{ "E", "2" } };
	...
	public void setInstrumentSetting(InstrumentSetting instrumentSetting) {
		...
		if (instrumentSetting == InstrumentSetting.AUTO)
			detectedInstrument = Instrument.NONE;
	}
