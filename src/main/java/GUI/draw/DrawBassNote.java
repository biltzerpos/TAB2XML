...
public class DrawBassNote {
	 ...
	 */
	public DrawBassNote(Pane pane, Note note, double startX, double startY, int font) {
		super();
		this.note = note;
		this.startX = startX;
		this.startY = startY;
	 ...
	 */
	public DrawBassNote(Pane pane, double startX, double startY) {
		super();
		this.startX = startX;
		this.startY = startY;
		this.pane = pane;
