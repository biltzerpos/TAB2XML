...
public class Highlighter {
	...
	public StyleSpans<Collection<String>> computeHighlighting(String text) {
		...
		for (Range range : errorRanges) {
			...
			if (ERROR_SENSITIVITY < errorPriority)
				continue;
	...
	private String getMessageOfCharAt(int index) {
		...
		// over the top, just for efficiency. search the array of ranges "errorRanges"
		// to find the range which contains(i.e includes) the number "index"
	...
	private String getErrorStyleClass(int priority) {
		switch (priority) {
		case 1:
			return "highPriorityError";
		case 2:
			return "mediumPriorityError";
		case 3:
			return "lowPriorityError";
		case 4:
			return "unimportantError";
		default:
